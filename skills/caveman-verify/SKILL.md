...
description: >-
  ...
  повторилось (RCA, blameless). Триггеры: проверь, дотошно, мелочь, как есть, как должно, состояние, пути, связи, отмена,,повторить, постмортем, корень проблемы, 5 почему, рка, не повторил, баг вернулся.
