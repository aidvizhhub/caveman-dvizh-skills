...
- `tests/golden_triggers.py` — **золотые тесты триггеров** (вызываются из validate.sh): у каждого скилла есть непустой список триггеров, каждый триггер существует в тексте скилла, нет дублей; двусмысленности («один триггер на два скилла») и ложные вызовы — предупреждения.
